<div class="bg-white">
  <div class="m-8">
    ...
    <p>
      The use of the Internet pages of the knothe.me is possible without any
    ...
    <p>
      ...
      knothe.me. By means of this data protection declaration, would like to
    ...
    <p>
      As the controller, the knothe.me has implemented numerous technical and
    ...
    <h4>1. Definitions</h4>
    <p>
      The data protection declaration of the knothe.me is based on the terms
    ...
    <h4>2. knothe.me and Address of the controller</h4>
    <p>
    ...
    <p>Tim Knothe</p>
    <p>Felsennelenanger 11</p>
    <p>80937 München</p>
    <p>Germany</p>
    <p>Email: fmj99cr67b@privaterelay.appleid.com</p>
    <p>Website: www.knothe.me</p>

    <h4>3. Collection of general data and information</h4>
    <p>
      The website of the knothe.me collects a series of general data and
    ...
    <p>
      When using these general data and information, the knothe.me does not draw
      ...
      Therefore, the knothe.me analyzes anonymously collected data and
      information statistically, with the aim of increasing the data protection
      and data security, and to ensure an optimal level of protection for the
    ...
    <ul style="list-style: none;">
      ...
      <li>
        ...
        <p>
          ...
          knothe.me, he or she may, at any time, contact any employee of the
          controller. An employee of knothe.me shall promptly ensure that the
        ...
        <p>
          ...
          required. An employees of the knothe.me will arrange the necessary
      ...
      <li>
        ...
        <p>
          ...
          stored by the knothe.me, he or she may at any time contact any
          employee of the controller. The employee of the knothe.me will arrange
      ...
      <li>
        ...
        <p>
          ...
          at any time contact any employee of the knothe.me.
        </p>
      </li>
      <li>
        ...
        <p>
          The knothe.me shall no longer process the personal data in the event
        ...
        <p>
          If the knothe.me processes personal data for direct marketing
          ...
          to such direct marketing. If the data subject objects to the knothe.me
          to the processing for direct marketing purposes, the knothe.me will no
        ...
        <p>
          ...
          data concerning him or her by the knothe.me for scientific or
        ...
        <p>
          ...
          any employee of the knothe.me. In addition, the data subject is free
      ...
      <li>
        ...
        <p>
          ...
          it is based on the data subject's explicit consent, the knothe.me
    ...
    <p>
      Developed by the specialists for <a href="https://willing-able.com/"
        >LegalTech</a
      >
      at Willing & Able that also developed the system for
      <a href="https://abletorecords.com/">data impact assessment</a>. The legal
      ...
      <a href="https://www.wbs.legal/" rel="nofollow">Christian Solmecke</a> from
      WBS law.
    </p>
  </div>
</div>
