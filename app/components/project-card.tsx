...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 border-0 shadow-md bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm flex flex-col gap-0 h-full overflow-hidden">
      <CardHeader className="pb-4">
        ...
        <div className="text-xs text-muted-foreground/80 mt-2.5 font-medium tracking-wide">
      ...
      <CardFooter className="pt-4 mt-auto bg-muted/20">
